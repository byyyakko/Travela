        ...
        <div className="grid md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/70 text-sm">
              <li><a href="#" className="hover:text-background transition-colors">Browse Locals</a></li>
              ...
              <li><a href="#" className="hover:text-background transition-colors">Food Tours</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-background/70 text-sm">
              <li><a href="#" className="hover:text-background transition-colors">Become a Guide</a></li>
